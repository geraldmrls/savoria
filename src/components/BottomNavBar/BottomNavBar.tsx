...
export function BottomNavBar() {
  ...
  return (
    <nav className={cn(
      ...
      <button
        onClick={() => navigateTo("/")}
        className={`py-2 px-5 rounded-full flex flex-col items-center gap-1 ${pathname === "/" ? "bg-primary-bg" : ""} ${pathname === "/" ? "text-yellow-border" : "text-gray-500"}`}
      >
      ...
      <button
        ...
        className={`py-2 px-5 rounded-full flex flex-col items-center gap-1 ${pathname === "/menu" ? "bg-primary-bg" : ""} ${pathname === "/menu" ? "text-yellow-border" : "text-gray-500"}`}
      >
      ...
      <button
        ...
        className={`py-2 px-5 rounded-full flex flex-col items-center gap-1 ${pathname === "/showcase" ? "bg-primary-bg" : ""} ${pathname === "/showcase" ? "text-yellow-border" : "text-gray-500"}`}
      >
